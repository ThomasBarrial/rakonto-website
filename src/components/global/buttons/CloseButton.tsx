...
function CloseButton({ onClick }: IProps) {
  return (
    <button onClick={onClick} type="button">
      <div className="border group bg-primary  border-background transform hover:border-none hover:bg-background rounded-full h-10 w-10 flex items-center justify-center duration-300">
